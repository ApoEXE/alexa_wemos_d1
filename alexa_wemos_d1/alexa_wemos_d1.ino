...
const char* ssid = "JAVI";            // CHANGE: Wifi name
const char* password = "xavier1234";  // CHANGE: Wifi password
String friendlyName = "sala";        // CHANGE: Alexa device name
const int relayPin = D2;              // D1 pin. More info: https://github.com/esp8266/Arduino/blob/master/variants/d1_mini/pins_arduino.h#L49-L61
...
void respondToSearch() {
  ...
  String response =
    ...
    "EXT:\r\n"
    "LOCATION: http://"
    + String(s) + ":80/setup.xml\r\n"
                  "OPT: \"http://schemas.upnp.org/upnp/1/0/\"; ns=01\r\n"
                  "01-NLS: b9200ebb-736d-4b93-bf03-835149d13983\r\n"
                  "SERVER: Unspecified, UPnP/1.0, Unspecified\r\n"
                  "ST: urn:Belkin:device:**\r\n"
                  "USN: uuid:"
    + persistent_uuid + "::urn:Belkin:device:**\r\n"
